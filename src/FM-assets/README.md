...
- header (without theme functionality, just keep UI)
- implement search UI + functionality
- implement cards for desktop and mobile and filter out cards

- look into search by region
